...
console.log("eere"+neil);
neil.forEach(n=>n.remove());

        let limit = parseInt(e.target.value);
        // console.log(limit); // get value which is selected in view item in a page
        displayPage(limit);
    }           
    ...
    displayPage(4); // by default how many rows
        ...
        if(nofTr <= limit){
            ...
            for(i=1; i<=nofPage; i++){
                ...
                a.onclick = e =>{
                    ...
                    tbody.innerHTML = '';
                    // let selectList = ul.querySelectorAll('.list');
                    // var anchor = selectList.querySelector("a");
                    // console.log(anchor.getAttribute('data-page'));
                    // if(getAttribute('data-page') == x){
                    //     selectList.style.display = 'flex';
                    // }else{
                    //     selectList.style.display = 'none';
                    // }
                    // console.log(x); // get page number which is pressed
                    x--;
                    let start = limit * x;
                    let end = start + limit;
